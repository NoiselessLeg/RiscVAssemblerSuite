   ...
   public class CommandTable
   {
                          ...
                          TerminationManager termMgr)
      {
         var tmpCmdList = new List<IConsoleCommand>()
         {
            ...
            new DumpRegistersCommand(executive.Registers, terminal),
            new DumpMemoryCommand(executive, terminal),
            new FormatAndDumpRegistersCommand(executive.Registers, terminal),
            new FormatAndDumpMemoryCommand(executive, terminal),
            new ReadRegisterCommand(executive.Registers, terminal),
            new FormatAndReadRegisterCommand(executive.Registers, terminal),
            new ReadMemoryCommand(executive, terminal),
            new FormatAndReadMemoryCommand(executive, terminal),
            new WriteRegisterCommand(executive.Registers, terminal),
