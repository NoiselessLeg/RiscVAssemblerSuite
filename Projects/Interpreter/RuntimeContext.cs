...
namespace Assembler.Interpreter
{
   ...
   {
      public RuntimeContext(IRuntimeEnvironment env, RuntimeDataSegmentAccessor dataSegment)
      {
         m_Environment = env;
      ...
      public RuntimeContext(IRuntimeEnvironment env, RuntimeDataSegmentAccessor dataSegment, IList<IRegister> userRegisters)
      {
