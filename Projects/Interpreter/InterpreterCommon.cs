...
namespace Assembler.Interpreter
{
   ...
   public class InterpreterCommon
   {
      ...
      /// </summary>
      public const int MAX_BASIC_REGISTERS = 33;
      ...
      /// <summary>
      /// Defines how many floating point registers are used in the processor.
      /// </summary>
      public const int MAX_FLOATING_PT_REGISTERS = 32;

      /// <summary>
      /// Defines the index of the program counter register.
      /// </summary>
      public const int PC_REGISTER = MAX_BASIC_REGISTERS - 1;
