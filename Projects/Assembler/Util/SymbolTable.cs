...
namespace Assembler.Util
{
    ...
    class SymbolTable
    {
        ...
        public SymbolTable()
        {
            m_Table = new Dictionary<string, Label>();
        }
        ...
        public void AddSymbol(Label label)
        {
        ...
        public Label GetSymbol(string symbolName)
        {
        ...
        private readonly Dictionary<string, Label> m_Table;
    }
}
