...
{
   class FsqrtsStringifier : IParameterStringifier
   {
      public FsqrtsStringifier(string instructionName)
      {
      ...
      public string GetFormattedInstruction(int currPgrmCtr, DisassembledInstruction inst, ReverseSymbolTable symTable)
      {
         ...
         {
            throw new ArgumentException("Fsqrt.s instruction expected 2 arguments, received " + inst.Parameters.Count());
         }
