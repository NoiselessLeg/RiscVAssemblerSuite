...
namespace Assembler.OutputProcessing
{
   ...
   public class TextSegmentAccessor
   {
      ...
      /// </summary>
      public IEnumerable<DisassembledInstruction> RawInstructions => m_Instructions;

      /// <summary>
      /// Gets the runtime starting address of this segment.
      /// </summary>
      public int StartingSegmentAddress => m_StartingSegmentAddress;

      /// <summary>
      /// Gets the size of the text segment, in bytes.
      /// </summary>
      public int SegmentSize => m_SegmentSize;
